			...
			<div className="container">
				<div className={'relative flex justify-between items-center max-md:flex-col max-md:gap-8'}>
					...
					<div className={'text-white flex items-center gap-5 justify-end'}>
						<Link href={isLoadingUser ? ('moderator' in userContext && userContext.moderator ? PUBLIC_URL.products() : PUBLIC_URL.home('#products')) : '#'} className={'text-lg text-black py-3.5 px-6 bg-white rounded-full uppercase font-medium border-2 border-solid border-transparent hover:bg-transparent hover:text-white hover:border-white hover:scale-105 duration-300'}>
							Кибертовары
						</Link>
