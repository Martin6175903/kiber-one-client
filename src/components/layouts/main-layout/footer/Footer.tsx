...
const Footer = () => {
	return (
		<footer className={'bg-linear-[0deg,#282828_0%,#080808_24%,#010101_60%,#131010_100%] pt-15 pb-5 text-white flex-[0_0_auto]'}>
			<div className="container">
				<div className={'flex flex-wrap sm:justify-center md:grid gap-10 grid-cols-3'}>
					<div className={'sm:basis-2/5'}>
						<h3 className={'text-2xl sm:text-3xl font-semibold'}>Контакты</h3>
						<p className={'mt-2.5 mb-5 max-sm:text-sm'}>
					...
					<div className={'sm:basis-2/5 max-sm:text-sm'}>
					...
					<div className={'text-sm  max-sm:text-xs max-sm:leading-[1.8]'}>
						Адрес: <strong></strong> г. Екатеринбург, Московская 66-159 <br/>
						<strong>ИНН:</strong> 660903120896, <br/> <strong>ОГРНИП</strong> 319665800050687 <br/>
				...
				<div className={'mt-20 text-[#888888] text-center max-sm:text-sm'}>
