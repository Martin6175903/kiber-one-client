...
const CityForm = () => {
  ...
  const title = cities && (cities.length ? 'Изменить данные' : 'Создать раздел "Город"')
  const action = cities && (cities.length ? 'Сохранить' : 'Создать')

  const form = useForm<ICity>({
    mode: 'onChange',
    values: cities && cities.length ? ({
      city: cities[0].city,
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className={'flex flex-col gap-5'}>
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder={'Город...'} disabled={isUpdatedCity || isCreatedCity} {...field}/>
                  </FormControl>
                  <FormMessage/>
                </FormItem>
              )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder={'+375(__)___-__-__'} disabled={isUpdatedCity || isCreatedCity} {...field}/>
                      </FormControl>
                      <FormMessage/>
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder={'ivanov@gmail.com'} disabled={isUpdatedCity || isCreatedCity} {...field}/>
                      </FormControl>
                      <FormMessage/>
                    </FormItem>
                  )}
            ...
            <FormField
              ...
              render={(field) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder={'Ссылка...'} disabled={isUpdatedCity || isCreatedCity} {...field}/>
                  </FormControl>
                  <FormMessage/>
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder={'Ссылка на оплату...'} disabled={isUpdatedCity || isCreatedCity} {...field}/>
                  </FormControl>
                  <FormMessage/>
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder={'Количество за урок...'} type={'number'} disabled={isUpdatedCity || isCreatedCity} {...field}/>
                  </FormControl>
                  <FormMessage/>
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder={'Количество бонуса...'} type={'number'} disabled={isUpdatedCity || isCreatedCity} {...field}/>
                  </FormControl>
                  <FormMessage/>
                </FormItem>
              )}
            ...
            <div className={'flex justify-center'}>
              <Button className={'max-w-1/2 w-full'} variant={'default'} disabled={isUpdatedCity || isCreatedCity}>{action} данные о разделе</Button>
            </div>
          </form>
        </Form>
      </div>
