	...
	return (
		<div className={'container'}>
			<div className={'mt-5'}>
				...
				<p className={'mt-3 font-medium text-base md:text-xl'}>Информация о вас:</p>
				<p className={' text-base md:text-xl mb-7'}>{user ? <span>{user.name}, {user.group!.title}, {dayLesson(user.group!.dayOfStudy)}, {user.group!.startTimeLearning} - {user.group!.endTimeLearning}</span> : <span>(Группа не указана)</span>}</p>
